		            ...
		            <div className="row py-3">
		                <div className="col-lg-4 col-md-6 mb-4 mb-lg-0"><img src="img/logo.png" alt="" width="180" className="mb-3"/>
		                    ...
		                    <ul className="list-inline mt-4">
		                        ...
		                        <li className="list-inline-item"><i className="fa fa-pinterest"></i></li>
		                    </ul>
		                </div>
		                <div className="col">
		                </div>
		                <div className="col-lg-4 col-md-6 mb-lg-0 text-white">
		                    ...
		                    <p><i className="fa fa-home mr-3"></i> Cajvana, nr 2058, Suceava, România</p>
		                    <p><i className="fa fa-envelope mr-3"></i> moderndisign849@gmail.com</p>
		                    <p><i className="fa fa-phone mr-3"></i> +40746 086 433</p>
		                </div>
		            </div>
		        </div>
		    </footer>
